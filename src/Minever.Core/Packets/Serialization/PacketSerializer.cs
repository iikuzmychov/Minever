...
namespace Minever.Core.Packets.Serialization;
...
public static class PacketSerializer
{
    ...
    public static void Serialize(MinecraftWriter writer, object value)
    {
        ...
        var converter = PacketConverter.GetConverter(value.GetType());
    ...
    public static object Deserialize(MinecraftReader reader, Type targetType)
    {
        ...
        var converter = PacketConverter.GetConverter(targetType);
